package com.iptv.gameportal.functional;
...
import com.iptv.gameportal.GamePortalServer;
import com.iptv.modules.test.data.DataFixtures;
import com.iptv.modules.test.jetty.JettyFactory;
import com.iptv.modules.test.spring.Profiles;
import com.iptv.modules.utils.PropertiesLoader;
...
public class BaseFunctionalTestCase {
	...
	protected static void startJettyOnce() throws Exception {
		if (jettyServer == null) {
			...
			jettyServer = JettyFactory.createServerInSource(new URL(baseUrl).getPort(), GamePortalServer.CONTEXT);
			JettyFactory.setTldJarNames(jettyServer, GamePortalServer.TLD_JAR_NAMES);
			jettyServer.start();
